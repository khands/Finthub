...
class BSKPDFManagerDashboard {
	...
	public function __construct( $arg ) {
		...
		$this->_bsk_pdf_manager_plugin_version = $arg['plugin_version'];	
		...
		$this->_obj_init_args['plugin_version'] = $this->_bsk_pdf_manager_plugin_version;
	...
	function bsk_pdf_manager_dashboard_menu() {
		...
		add_menu_page('BSK PDF Manager', 'BSK PDF Manager', $authorized_level, 'bsk-pdf-manager', '', 'dashicons-media-document');
	...
	function bsk_pdf_manager_pdfs(){
		...
		if ($lists_curr_view == 'list'){
			...
			echo '<div class="wrap">
					...
					'.$this->bsk_pdf_manager_show_pro_tip_box().'
			...
			echo '  </form>
					<span class="bsk-pdf-pro-tip-viewer bsk-pdf-align-left dashicons dashicons-visibility" id="tip_4_bsk_pdf_manager_bulk_change_category_view_id" attrid="tip_4_bsk_pdf_manager_bulk_change_category_id"></span>
                    <input type="hidden" id="tip_4_bsk_pdf_manager_bulk_change_category_id" value="Bulck change PDFs\' category, available for Pro version." />
				  </div>';
		...
		echo '<div class="wrap">';
		echo '<input type="hidden" id="bsk_pdf_manager_hidden_tip_box_tip_ID" value="'.$this->bsk_pdf_manager_get_pro_tip_text().'" />';
		echo '</div>';
	}
	...
	function bsk_pdf_manager_settings_support(){
		...
		<?php 
			echo $this->bsk_pdf_manager_show_pro_tip_box();
	...
	function bsk_pdf_manager_show_pro_tip_box(){
		...
		<div class="bsk-pro-tips-box">
			<b>Pro Tip: </b><span class="bsk-pro-tips-box-tip">'.$this->bsk_pdf_manager_get_pro_tip_text().'</span>
	...
	function bsk_pdf_manager_pdfs_add_by_ftp_interface(){
		...
		$this->_bsk_pdf_manager_OBJ_pdf->bsk_pdf_manager_pdfs_add_by_ftp();
